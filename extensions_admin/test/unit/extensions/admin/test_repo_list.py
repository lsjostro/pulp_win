...
from pulp_win.extensions.admin import repo_list
...
class RepoListCommandTests(PulpClientTests):
    def test_get_repositories(self):
        ...
        repos = [
            {
                ...
                'importers': [
                    {'config': {}, 'id': ids.TYPE_ID_IMPORTER_WIN}],
                'distributors': [{'id': ids.TYPE_ID_DISTRIBUTOR_WIN}],
            },
            {
                'id': 'no-importers',
                'notes': {pulp_constants.REPO_NOTE_TYPE_KEY:
        ...
        distributor_list = [ids.TYPE_ID_DISTRIBUTOR_WIN]
